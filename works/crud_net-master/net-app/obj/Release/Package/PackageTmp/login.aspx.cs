...
public partial class Login : System.Web.UI.Page
{
    ...
    public void LoginUser(object sender, EventArgs e)
    {
        ...
        using (var cmd = new MySqlCommand(string.Format("SELECT * FROM mysql.users WHERE username = '{0}' AND password = '{1}'", this.username.Text, CalculateMD5Hash(this.password.Text))))
        {
